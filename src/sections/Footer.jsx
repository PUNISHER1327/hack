...
import { FaDiscord, FaLinkedin, FaInstagram, FaTwitter, FaEnvelope, FaPhoneAlt } from 'react-icons/fa';
...
>>>>>>> f758ac6 (Added my changes)
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass-panel flex items-center justify-center hover:text-neonBlue hover:border-neonBlue transition-all"><FaDiscord /></a>
              <a href="#" className="w-10 h-10 rounded-full glass-panel flex items-center justify-center hover:text-neonBlue hover:border-neonBlue transition-all"><FaLinkedin /></a>
